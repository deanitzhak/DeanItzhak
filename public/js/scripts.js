...
let All_Gallery_Images_First_First = document.getElementById("All_Gallery_Images_First_First");
let All_Gallery_Images_First_Second = document.getElementById("All_Gallery_Images_First_Second");
let All_Gallery_Images_First_Third = document.getElementById("All_Gallery_Images_First_Third");
let All_Gallery_Images_First_Forth = document.getElementById("All_Gallery_Images_First_Forth");
let All_Gallery_Images_First_Fifth = document.getElementById("All_Gallery_Images_First_Fifth");
let All_Gallery_Images_Second_First = document.getElementById("All_Gallery_Images_Second_First");
let All_Gallery_Images_Second_Second = document.getElementById("All_Gallery_Images_Second_Second");
let All_Gallery_Images_Second_Third = document.getElementById("All_Gallery_Images_Second_Third");
let All_Gallery_Images_Second_Forth = document.getElementById("All_Gallery_Images_Second_Forth");
let All_Gallery_Images_Second_Fifth = document.getElementById("All_Gallery_Images_Second_Fifth");
let All_Gallery_Images_Third_First = document.getElementById("All_Gallery_Images_Third_First");
let All_Gallery_Images_Third_Second = document.getElementById("All_Gallery_Images_Third_Second");
let All_Gallery_Images_Third_Third = document.getElementById("All_Gallery_Images_Third_Third");
let All_Gallery_Images_Third_Forth = document.getElementById("All_Gallery_Images_Third_Forth");
let All_Gallery_Images_Third_Fifth = document.getElementById("All_Gallery_Images_Third_Fifth");
...
function Photography_B1130(){
    ...
    Third_Gallery_Item_First.style.paddingTop = "0px";
    Third_Gallery_Item_Second.style.paddingTop = "0px";
    Third_Gallery_Item_Third.style.paddingTop = "0px";
    Third_Gallery_Item_Forth.style.paddingTop = "0px";
    Third_Gallery_Item_Fifth.style.paddingTop = "0px";
    Second_Gallery_Item_First.style.paddingTop = "0px";
    Second_Gallery_Item_Second.style.paddingTop = "0px";
    Second_Gallery_Item_Third.style.paddingTop = "0px";
    Second_Gallery_Item_Forth.style.paddingTop = "0px";
    Second_Gallery_Item_Fifth.style.paddingTop = "0px";
    Gallery_Item_First.style.paddingTop = "0px";
    Gallery_Item_Second.style.paddingTop = "0px";
    Gallery_Item_Third.style.paddingTop = "0px";
    Gallery_Item_Forth.style.paddingTop = "0px";
    Gallery_Item_Fifth.style.paddingTop = "0px";
    All_Gallery_Images_First_First.style.width = "fit-content";
    All_Gallery_Images_First_Second.style.width = "fit-content";
    All_Gallery_Images_First_Third.style.width = "fit-content";
    All_Gallery_Images_First_Forth.style.width = "fit-content";
    All_Gallery_Images_First_Fifth.style.width = "fit-content";
    All_Gallery_Images_Second_First.style.width = "fit-content";
    All_Gallery_Images_Second_Second.style.width = "fit-content";
    All_Gallery_Images_Second_Third.style.width = "fit-content";
    All_Gallery_Images_Second_Forth.style.width = "fit-content";
    All_Gallery_Images_Second_Fifth.style.width = "fit-content";
    All_Gallery_Images_Third_First.style.width = "fit-content"; 
    All_Gallery_Images_Third_Second.style.width = "fit-content";
    All_Gallery_Images_Third_Third.style.width = "fit-content";
    All_Gallery_Images_Third_Forth.style.width = "fit-content"; 
    All_Gallery_Images_Third_Fifth.style.width = "fit-content"; 
    Gallery_Item_First.onmouseover = First_First_Over_B1028;
    Gallery_Item_Second.onmouseover = First_Second_Over_B1028;
    Gallery_Item_Third.onmouseover = First_Third_Over_B1028;
    Gallery_Item_Forth.onmouseover = First_Forth_Over_B1028;
...
function Photography_S800(){
    ...
    Init_All_Item_Gallery_Holder_S1130();
    First_Gallery.style.display = "block";
    Second_Gallery.style.display = "block";
    Third_Gallery.style.display = "block";

    First_Gallery.style.widows = "100%";
    Second_Gallery.style.widows = "100%";
    Third_Gallery.style.width = "100%";

    All_Gallery_Images_First_First.style.width = "100%";
    All_Gallery_Images_First_Second.style.width = "100%";
    All_Gallery_Images_First_Third.style.width = "100%";
    All_Gallery_Images_First_Forth.style.width = "100%";
    All_Gallery_Images_First_Fifth.style.width = "100%";
    All_Gallery_Images_Second_First.style.width = "100%";
    All_Gallery_Images_Second_Second.style.width = "100%";
    All_Gallery_Images_Second_Third.style.width = "100%";
    All_Gallery_Images_Second_Forth.style.width = "100%";
    All_Gallery_Images_Second_Fifth.style.width = "100%";
    All_Gallery_Images_Third_First.style.width = "100%"; 
    All_Gallery_Images_Third_Second.style.width = "100%";
    All_Gallery_Images_Third_Third.style.width = "100%";
    All_Gallery_Images_Third_Forth.style.width = "100%"; 
    All_Gallery_Images_Third_Fifth.style.width = "100%"; 
    Third_Gallery_Item_First.style.width = "inherit";
    Third_Gallery_Item_Second.style.width = "inherit";
    Third_Gallery_Item_Third.style.width = "inherit";
    Third_Gallery_Item_Forth.style.width = "inherit";
    Third_Gallery_Item_Fifth.style.width = "inherit";
    Second_Gallery_Item_First.style.width = "inherit";
    Second_Gallery_Item_Second.style.width = "inherit";
    Second_Gallery_Item_Third.style.width = "inherit";
    Second_Gallery_Item_Forth.style.width = "inherit";
    Second_Gallery_Item_Fifth.style.width = "inherit";
    Gallery_Item_First.style.width = "inherit";
    Gallery_Item_Second.style.width = "inherit";
    Gallery_Item_Third.style.width = "inherit";
    Gallery_Item_Forth.style.width = "inherit";
    Gallery_Item_Fifth.style.width = "inherit";

    Third_Gallery_Item_First.style.paddingTop = "10px";
    Third_Gallery_Item_Second.style.paddingTop = "10px";
    Third_Gallery_Item_Third.style.paddingTop = "10px";
    Third_Gallery_Item_Forth.style.paddingTop = "10px";
    Third_Gallery_Item_Fifth.style.paddingTop = "10px";
    Second_Gallery_Item_First.style.paddingTop = "10px";
    Second_Gallery_Item_Second.style.paddingTop = "10px";
    Second_Gallery_Item_Third.style.paddingTop = "10px";
    Second_Gallery_Item_Forth.style.paddingTop = "10px";
    Second_Gallery_Item_Fifth.style.paddingTop = "10px";
    Gallery_Item_First.style.paddingTop = "10px";
    Gallery_Item_Second.style.paddingTop = "10px";
    Gallery_Item_Third.style.paddingTop = "10px";
    Gallery_Item_Forth.style.paddingTop = "10px";
    Gallery_Item_Fifth.style.paddingTop = "10px";
}
...
function Codes_S1000(){
    Codes_S1460_B1000();
    Upper_Code.style.display = "contents";
    Second_Upper_Code.style.display = "contents";
    Third_Upper_Code.style.display = "contents";
